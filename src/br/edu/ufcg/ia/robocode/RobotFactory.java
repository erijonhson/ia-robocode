...
public class RobotFactory {
	...
	public final static String FILE_TO_COMPILE = "robots/ia/ModelWithAllSamples.java"; // "robots/jeuj/JeujDaPeu.java"
	...
	public static void createRobotFile(int[] chromo) {
		try {
			FileWriter fstream = new FileWriter(FILE_TO_COMPILE);
